      ...
      <div className="grid md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-lg bg-gradient-violet-cyan grid place-items-center font-display font-bold text-primary-foreground">L</div>
        ...
        <div>
          <div className="text-sm font-semibold uppercase tracking-widest text-muted-foreground">Resources</div>
          <ul className="mt-4 space-y-3 text-sm">
            <li><a href="#about" className="text-foreground/80 hover:text-primary">About</a></li>
            <li><a href="#" className="text-foreground/80 hover:text-primary">Whitepaper</a></li>
        ...
        <div>
          <div className="text-sm font-semibold uppercase tracking-widest text-muted-foreground">Stay Updated</div>
          <form className="mt-4 flex gap-2" onSubmit={(e) => e.preventDefault()}>
            <Input type="email" placeholder="you@email.com" className="bg-secondary/50 border-border/60" />
