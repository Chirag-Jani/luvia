...
export type LuviaPresale = {
  address: "3UFQfTbemvnU5ADGfQ4hQHckAm3x9iHrzMpkC6M3z5Ho";
  metadata: {
    name: "luviaPresale";
    version: "0.1.0";
    spec: "0.1.0";
  ...
  instructions: [
    {
      ...
      discriminator: [245, 116, 218, 214, 50, 98, 155, 205];
      accounts: [
        {
          name: "admin";
          signer: true;
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          docs: ["in `load_sol_usd_price_micro` before we use the price."];
        },
        {
          name: "tokenProgram";
        },
    ...
    {
      name: "pause";
      docs: ["Emergency stop — blocks all buys."];
    ...
    },
    {
      ...
      discriminator: [78, 187, 249, 250, 223, 244, 237, 79];
      accounts: [
        {
          name: "admin";
          signer: true;
    ...
    },
    {
      ...
      discriminator: [132, 251, 59, 118, 38, 162, 168, 77];
      accounts: [
        {
          name: "admin";
          writable: true;
  ...
  accounts: [
    {
      name: "presaleConfig";
      discriminator: [115, 71, 85, 233, 246, 108, 30, 3];
    },
  ];
  events: [
    {
      name: "minPurchaseUpdated";
      discriminator: [110, 84, 171, 22, 79, 66, 205, 198];
    },
    {
      name: "pausedChanged";
      discriminator: [12, 10, 153, 247, 60, 115, 137, 69];
    },
    {
    ...
    },
    {
      ...
      discriminator: [241, 12, 117, 85, 109, 175, 143, 151];
    },
  ];
  errors: [
    {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "treasury";
            docs: ["PDA used in buy-time SOL routing path."];
            type: "pubkey";
          },
          {
            name: "tokenMint";
            docs: ["LUVIA Token-2022 mint address."];
            type: "pubkey";
          },
          {
            name: "tokenVault";
            docs: ["ATA owned by this config PDA that holds presale tokens."];
            type: "pubkey";
          },
          {
            name: "pythPriceUpdate";
            docs: ["Pyth pull-oracle price update account for SOL/USD."];
            type: "pubkey";
          },
          {
            name: "currentStage";
          ...
          {
            name: "bump";
            docs: ["Bump for the config PDA."];
            type: "u8";
          },
          {
            name: "treasuryBump";
            docs: ["Bump for the treasury PDA."];
            type: "u8";
          },
          {
            name: "padding";
            docs: ["Reserved for future use / alignment."];
            type: {
              array: ["u8", 4];
            };
          },
          ...
          {
            name: "presaleStartTs";
            docs: ["Presale start timestamp (unix seconds, source of truth)."];
            type: "i64";
          },
          {
            name: "presaleEndTs";
            docs: ["Presale end timestamp (unix seconds, source of truth)."];
            type: "i64";
          },
          {
            name: "totalTokensSold";
            docs: ["Total tokens sold across all stages (base units)."];
            type: "u64";
          },
          {
            name: "totalSolRaised";
            docs: ["Total SOL taken into the treasury (lamports)."];
            type: "u64";
          },
          {
            name: "stages";
            docs: ["Per-stage configuration + progress."];
            type: {
              array: [
                {
                  defined: {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "priceMicroUsd";
            docs: ["Token price in micro-USD (6 decimals): $0.01 => 10_000."];
            type: "u64";
          },
          {
            name: "allocation";
            docs: ["Hard cap for this stage in base units (9 decimals)."];
            type: "u64";
          },
          {
            name: "sold";
            docs: ["Already-sold tokens in this stage (base units)."];
            type: "u64";
          },
        ];
      };
